  ...
  public DruidRecordWriter(DataSchema dataSchema,
    ...
    appenderator = Appenderators
        .createOffline("hive-offline-appenderator", this.dataSchema, tuningConfig, new FireDepartmentMetrics(),
            ...
            DruidStorageHandlerUtils.INDEX_MERGER_V9, null, null);
    // String id, DataSchema schema, AppenderatorConfig config, FireDepartmentMetrics metrics, DataSegmentPusher dataSegmentPusher,
    // ObjectMapper objectMapper, IndexIO indexIO,
    // IndexMerger indexMerger, RowIngestionMeters rowIngestionMeters, ParseExceptionHandler parseExceptionHandler
